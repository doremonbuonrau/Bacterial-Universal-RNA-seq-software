# Legacy network entry point; opens the combined Functional Enrichment and Co-expression Networks application.
$global:BacterialRNAAnalysisDownstreamModule = 'network'
