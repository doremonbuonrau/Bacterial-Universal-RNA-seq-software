# Standalone Differential Expression application
$global:BacterialRNAAnalysisDownstreamModule = 'de'
...
try {
    ...
    $details = @(
        "[$([DateTime]::Now.ToString('yyyy-MM-dd HH:mm:ss'))] Standalone Differential Expression application failed to start"
